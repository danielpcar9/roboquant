...
class TradingBehaviorLogger:
    ...
    def generate_daily_summary(self) -> str:
        ...
        try:
            ...
            approved_rate = (self.metrics['trades_aprobados'] / total) * 100
            ml_approval_rate = (self.metrics['ml_aprobados'] / total) * 100
            quant_approval_rate = (self.metrics['quant_aprobados'] / total) * 100
...
"""
            ...
            for symbol, counts in self.metrics['decisiones_por_simbolo'].items():
                ...
                approval_rate = (counts['aprobadas'] / total_symbol) * 100 if total_symbol > 0 else 0
...
# Singleton instance
_behavior_logger: Optional[TradingBehaviorLogger] = None
